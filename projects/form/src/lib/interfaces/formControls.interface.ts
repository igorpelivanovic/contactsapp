...
type GroupControlsFieldsType = GroupContolStringElementInterface | GroupContolNumberElementInterface | GroupControlPhoneElementInterface | GroupControlSelectElementInterface | GroupControlMailElementInterface 
type ArrayControlsFieldsType = ArrayContolStringElementInterface | ArrayContolNumberElementInterface | ArrayControlPhoneElementInterface | ArrayControlSelectElementInterface | ArrayControlMailElementInterface
